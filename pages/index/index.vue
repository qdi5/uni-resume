<template>
	 <view class="uni-padding-wrap" :style="{height: windowHeight + 'px'}">
		<view class="page-section">
			<view class="page-section-spacing">
				<swiper class="swiper">
					<swiper-item>
						<view class="content">
							<view class="name-wrapper">
								...
								<text class="name-spell">{{ resume.spell }}</text>
							</view>
							<view class="naigation">
								我的简历
								<image class="arrow-right" src="/static/arrow-right.png" mode="aspectFit"></image>
							</view>
							<image class="photo" src="/static/photo.jpg" mode="widthFit"></image>
							<veiw class="job-info">
								<view class="font-end">{{ resume.job }}</view>
								<view class="job-year">{{ resume.exp }}</view>
							</veiw>
							<view class="large-circle"></view>
					...
					<swiper-item>
						<view class="swiper-item uni-bg-green">
							<scroll-view scroll-y="true" class="scroll-Y" :style="{height: windowHeight + 'px'}">
								...
								<view class="area">
									<view class="theme d-flex v-center h-center">
										<text>3</text>教育经历
									</view>
									<view class="edu-wrapper" v-for="(edu, index) in resume.education" :key="index">
										<view class="d-flex horizontal v-center">
											<image class="school-img" src="../../static/icon_school.png" mode="widthFix"></image>
											{{ edu.school }}
										</view>
										<view class="d-flex horizontal jusify v-center">
											<view class="left">
					...
					<swiper-item>
						<view class="swiper-item uni-bg-blue">工作经历</view>
					</swiper-item>
					<swiper-item>
						<view class="swiper-item uni-bg-blue">项目经历</view>
					</swiper-item>
					<swiper-item>
						<view class="swiper-item uni-bg-blue">自我评价</view>
					</swiper-item>
				</swiper>
			</view>
		</view>
...
<script>
	export default {
		...
		onShow() {
			const sysIfno = uni.getSystemInfoSync()
			const width = sysIfno.windowWidth
			const height = sysIfno.windowHeight
